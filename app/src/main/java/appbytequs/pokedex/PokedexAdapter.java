...
public class PokedexAdapter<name, number> extends RecyclerView.Adapter<PokedexAdapter.PokedexViewHolder> {
    ...
    public void loadPokemon() {
        String url = "https://pokeapi.co/api/v2/pokemon?=limit10";
